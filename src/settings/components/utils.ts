...
export const TimeFormatOptions = (): SelectItem<'12h' | '24h'>[] => [
	{ label: t('settings.options.time_format.12h', '12-Hour (AM/PM)'), value: '12h' },
	{ label: t('settings.options.time_format.24h', '24-Hour (e.g. 14:00)'), value: '24h' }
];
