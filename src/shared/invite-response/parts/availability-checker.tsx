...
import { Icon, IconButton, Row, Text, Tooltip } from '@zextras/carbonio-design-system';
	...
	if (isBusy) {
		...
		return (
			<RowContainer>
				...
				<Row mainAlignment="flex-start" padding={{ horizontal: 'small' }}>
					<IconButton
						size="large"
				...
				{open && <AppointmentCardContainer start={start} end={end} rootId={rootId} />}
			</RowContainer>
		);
	}
